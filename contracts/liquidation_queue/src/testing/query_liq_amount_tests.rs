...
use cosmwasm_std::{from_binary, to_binary, BankMsg, Coin, CosmosMsg, Decimal, SubMsg, Uint128, Decimal256, Uint256};
...
fn partial_one_collateral_one_slot_high_ltv() {
    ...
    assert_eq!(
        ...
        LiquidationAmountResponse {
            collaterals: vec![("token0000".to_string(), Uint256::from(16429u64))], // No tax fee
        }
    );
...
fn partial_one_collateral_one_slot() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![("token0000".to_string(), Uint256::from(7273u64))], // No Tax fee
        }
    );
...
fn partial_one_collateral_one_slot_with_fees() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![("token0000".to_string(), Uint256::from(7401u64))], // No tax fee
        }
    );
    ...
    assert_eq!(
        ...
        vec![
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                ...
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(710u128), // No tax fee
                }]
            })),
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                ...
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(7u128), // No tax fee
                }]
            }))
        ]
    );
...
fn partial_one_collateral_one_slot_with_fees_all() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![("token0000".to_string(), Uint256::from(7532u64))], // No tax fee
        }
    );
    ...
    assert_eq!(
        ...
        vec![
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                ...
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(716u128), // No tax fee
                }]
            })),
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                to_address: "fee0000".to_string(),
...
fn partial_one_collateral_two_slots() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![("token0000".to_string(), Uint256::from(42841u64))], // No tax fee
        }
    );
...
fn partial_one_collateral_two_slots_with_fees() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![("token0000".to_string(), Uint256::from(43626u64))], // No tax fee
        }
    );
    ...
    assert_eq!(
        ...
        vec![
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                ...
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(4117u128), // repay amount = 4117, no tax fee
                }]
            })),
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                to_address: "fee0000".to_string(),
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(41u128), // No tax fee
                }]
            }))
        ]
    );
...
fn non_partial_liquidation() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![("token0000".to_string(), Uint256::from(12632u64))], // No tax fee
        }
    );
...
fn non_partial_liquidation_two_slots() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![("token0000".to_string(), Uint256::from(12745u64))], // No tax fee
        }
    );
...
fn non_partial_liquidation_with_fees() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![("token0000".to_string(), Uint256::from(12760u64))], // No tax fee
        }
    );
    ...
    assert_eq!(
        ...
        vec![
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                ...
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(1213u128), // repay all borrowed amount, no tax fee
                }]
            })),
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                to_address: "fee0000".to_string(),
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(12u128), // No tax fee
                }]
            }))
        ]
    );
...
fn non_partial_liquidation_two_slots_with_fees() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![("token0000".to_string(), Uint256::from(12874u64))], // No tax fee
        }
    );
    ...
    assert_eq!(
        ...
        vec![
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                ...
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(1212u128), // repay all borrowed amount, no tax fee
                }]
            })),
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                to_address: "fee0000".to_string(),
...
fn non_partial_liquidation_two_slots_with_fees_big_nums() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![("token0000".to_string(), Uint256::from(13822434876u64))], // No tax fee
        }
    );
    ...
    assert_eq!(
        ...
        vec![
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                ...
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(1301000000u128), // exact loan amount
                }]
            })),
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                to_address: "fee0000".to_string(),
...
fn partial_two_collaterals_ltv_diff() {
    ...
    assert_eq!(
        ...
        LiquidationAmountResponse {
            collaterals: vec![
                ("token0000".to_string(), Uint256::from(19230770u64)), // No tax fee
                ("token0001".to_string(), Uint256::from(399193549u64))  // No tax fee
            ],
        }
    );
...
fn partial_two_collaterals_multi_slots_per_col() {
    ...
    assert_eq!(
        ...
        LiquidationAmountResponse {
            collaterals: vec![
                ("token0000".to_string(), Uint256::from(3776u64)), // No tax fee
                ("token0001".to_string(), Uint256::from(9607u64))  // No tax fee
            ],
        }
    );
...
fn partial_two_collaterals_one_slot_diff_ltv() {
    ...
    assert_eq!(
        ...
        LiquidationAmountResponse {
            collaterals: vec![
                ("token0000".to_string(), Uint256::from(3019u64)), // No tax fee
                ("token0001".to_string(), Uint256::from(7747u64))  // No tax fee
            ],
        }
    );
...
fn partial_three_collaterals_one_slot_diff_ltv() {
    ...
    assert_eq!(
        ...
        LiquidationAmountResponse {
            collaterals: vec![
                ("token0000".to_string(), Uint256::from(3310u64)), // No tax fee
                ("token0001".to_string(), Uint256::from(5765u64)), // No tax fee
                ("token0002".to_string(), Uint256::from(1209u64)), // No tax fee
            ],
        }
    );
    ...
    assert_eq!(
        ...
        LiquidationAmountResponse {
            collaterals: vec![
                ...
                ("token0001".to_string(), Uint256::from(2471406686u64)), // No tax fee
...
fn not_enough_bids_for_one_of_two_col() {
    ...
    assert_eq!(
        ...
        LiquidationAmountResponse {
            collaterals: vec![
                ("token0000".to_string(), Uint256::from(11655875u64)), // No tax fee
                ("token0001".to_string(), Uint256::from(6451613u64))   // No tax fee
            ],
        }
    );
    ...
    assert_eq!(
        ...
        vec![
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                ...
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(291409u128), // No tax fee
                }]
            })),
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                to_address: "fee0000".to_string(),
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(2943u128), // No tax fee
                }]
            }))
        ]
    );
...
fn integration_test_simul() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![("token0000".to_string(), Uint256::from(8484841036u64)),], // No tax fee
        }
    );
    ...
    assert_eq!(
        ...
        vec![SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
            ...
            amount: vec![Coin {
                denom: "uusd".to_string(),
                amount: Uint128::from(5348633145u128), // No tax fee
            }]
        }))]
    );
}
