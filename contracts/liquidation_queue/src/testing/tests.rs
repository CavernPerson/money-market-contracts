...
use cosmwasm_std::{
    attr, from_json, to_json_binary, BankMsg, Coin, CosmosMsg, Decimal, Decimal256, StdError, SubMsg,
    Uint128, Uint256,
};
    ...
    assert_eq!(
        ...
        vec![
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                ...
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(485100u128), // 485100 / (1 + tax_rate)
                }]
            })),
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
                ...
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(4950u128), // 4950 / (1 + tax_rate)
                }]
            })),
            SubMsg::new(CosmosMsg::Bank(BankMsg::Send {
