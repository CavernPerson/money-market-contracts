...
use cosmwasm_std::{CanonicalAddr, Deps, Order, StdResult, Storage, Uint128, Uint256};
...
pub fn store_swap_config(storage: &mut dyn Storage, data: &SwapConfig) -> StdResult<()> {
    SWAP_CONFIG.save(storage, data)
}
